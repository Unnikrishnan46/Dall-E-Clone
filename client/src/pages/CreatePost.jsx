  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch("https://dall-e-server-six.vercel.app/api/v1/dalle",
          {
            method: 'POST',
            headers: {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        [500px]'>Create imaginative and visually stunning images through DALL-E AI and share them with the community</p>
      </div>
